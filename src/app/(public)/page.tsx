...
export const metadata: Metadata = {
  ...
  description:
    "India's most trusted IPO consultancy for SME & Mainboard IPO advisory. SEBI-compliant, end-to-end IPO services across Delhi, Mumbai & pan-India. 140+ successful IPOs.",
