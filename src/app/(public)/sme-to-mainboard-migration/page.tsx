        ...
        <section className="py-20 bg-background relative -mt-10 rounded-t-[40px] z-20">
          <div className="container mx-auto px-4 space-y-16">
            ...
            <div>
              ...
              <p className="leading-relaxed mb-6 text-slate-600 text-sm">
              ...
              <ul className="list-disc pl-5 space-y-3 text-slate-500 leading-relaxed text-sm">
              ...
              <p className="leading-relaxed mt-6 text-slate-600 text-sm">
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-3 text-slate-500 leading-relaxed text-sm mb-8">
              ...
              <p className="leading-relaxed mb-4 text-slate-600 text-sm">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-slate-500 leading-relaxed text-sm">
            ...
            <div>
              ...
              <p className="leading-relaxed mb-10 text-slate-600 text-sm">
            ...
            <div>
              ...
              <p className="leading-relaxed mb-8 text-slate-600 text-sm">
