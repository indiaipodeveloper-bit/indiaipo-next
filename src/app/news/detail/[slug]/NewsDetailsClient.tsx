...
const ArticleContent = ({ content }: { content: string }) => {
  ...
  if (hasHtmlTags(activeContent)) {
    return (
      <>
        ...
        `}</style>
        <div className="article-prose" dangerouslySetInnerHTML={{ __html: activeContent }} />
      </>
    );
  }
  ...
  paragraphs.forEach((para, i) => {
    ...
    const isHeading = (para.length < 80 && para === para.toUpperCase() && para.length > 5) ||
      ...
      (para.length < 50 && para.length > 8 && !para.includes(".") && !para.includes(",") && !para.includes("₹") && !para.includes("$") && paraIndex > 0);
...
export default function NewsDetailsClient({
  ...
  useEffect(() => {
    ...
    fetch(`${API_URL}/api/news`)
      ...
      .catch((err) => console.error("Error fetching latest news client-side:", err));
  }, [slug]);
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAFC]">
      ...
      <main className="flex-1">
          ...
          <div className="absolute inset-0 flex flex-col justify-end">
            <div className="container mx-auto px-4 pb-10 md:pb-14">
              ...
              <button
                ...
                className="flex items-center gap-2 text-white/70 hover:text-white text-sm font-semibold mb-5 transition-colors group cursor-pointer"
              >
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-12">
            <div className="xl:col-span-2">
              <div className="flex items-center gap-3 mb-8 pb-6 border-b border-slate-200 flex-wrap">
                ...
                <button
                  onClick={handleCopy}
                  className="ml-auto flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-black transition-all hover:scale-105 cursor-pointer"
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {latestNews.slice(0, 3).map((item) => {
                      ...
                      return (
                        <Link key={item.id} href={`/news/detail/${item.slug || item.id}`}
            ...
            <aside className="xl:col-span-1">
              <div className="sticky top-24 space-y-5">
                <div className="bg-white rounded-2xl border border-slate-200 shadow-xl overflow-hidden animate-none">
                ...
                <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden animate-none">
                  ...
                  <div className="px-4 pb-4">
                    <button
                      className="w-full py-2.5 rounded-xl text-sm font-black border border-[#001529]/20 text-[#001529] hover:bg-[#001529] hover:text-white flex items-center justify-center gap-2 transition-all group cursor-pointer"
                      onClick={() => router.push("/news")}>
        ...
        <section className="bg-gradient-to-r from-[#001529] via-[#002147] to-[#003380] py-20 relative overflow-hidden animate-none">
