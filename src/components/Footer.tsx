        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center mb-4">
              <img src={typeof logo === "string" ? logo : logo.src} alt="India IPO" className="h-14 w-auto rounded-lg" />
            </div>
      ...
      <div className="border-t border-background/10 bg-foreground">
        <div className="container mx-auto px-4 py-4 flex flex-col md:flex-row items-center justify-between gap-3">
          <div className="flex flex-wrap gap-4">
            <Link href="/disclaimer" className="text-xs text-background/80 hover:text-accent transition-colors">Disclaimer</Link>
